...
from tracker.views import (
    ...
    blocked_os_view, allowed_logs_view, allowed_logs_partial,
    allowed_logs_table, denied_logs_view, denied_logs_table,
    denied_logs_partial, allowed_country_view, blocked_hostname_view,
    dinger_ip_view, allowed_country_table, allowed_country_partial
    ,blocked_browser_view, blocked_browser_partial, blocked_browser_table,
    blocked_os_table, blocked_os_partial, blocked_hostname_table, blocked_hostname_partial,
    add_block_rule,
)
