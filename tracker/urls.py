...
from .views import dashboard_view,blocked_ips_partial, blocked_isp_table, blocked_isp_partial, blocked_ips_table, dinger_ip_view, delete_log, denied_logs_table, denied_logs_view, allowed_logs_table, home_redirect, blocked_ips_view, blocked_isp_view, blocked_os_view, blocked_browser_view,allowed_logs_view, allowed_country_view, blocked_hostname_view
...
urlpatterns = [
    ...
    path("dashboard/blocked-isps/partial/", blocked_isp_partial, name="blocked_isp_partial"),
    path("dashboard/blocked-isps/table/", blocked_isp_table, name="blocked_isp_table"),
